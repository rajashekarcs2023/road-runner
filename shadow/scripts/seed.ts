...
const SEED_ROWS = [
  { id: "REQ-001", text: "Hi - Sarah Johnson from Acme Corp here (sarah.j@acme.com). Do you support SSO, SAML, SOC2, HIPAA, and enterprise pricing? Need procurement docs by EOW. Reach me on cell at (650) 555-0142." },
  { id: "REQ-002", text: "Login is broken for everyone on Chrome since this morning. We are dead in the water. URGENT. Reply to ops@globex.io please." },
  { id: "REQ-003", text: "Can I get a student discount? Building a side project for my CS class. My .edu email is dpark@stanford.edu." },
  { id: "REQ-004", text: "Production API has been returning 503 for 20 minutes. All our customers are affected. Please respond ASAP. Status page: https://status.example.com" },
  { id: "REQ-005", text: "Need a copy of your SOC2 Type II report for our procurement team. Compliance audit next week. Send to compliance@megacorp.com" },
  { id: "REQ-006", text: "What's your enterprise pricing for 500 seats? Considering switching from a competitor. Reach me at 415.555.9000 — Linda Chen, Director of Operations." },
  ...
  { id: "REQ-009", text: "I'm getting a 500 error when trying to share a page externally. Browser console shows a JSON parse error. See repro at https://demo.example.com/bug/login-issue.png" },
  { id: "REQ-010", text: "Does your platform support HIPAA-compliant data handling? We're a healthcare company evaluating vendors. Contact: Dr. Mike Patel (mpatel@hospital.org)." },
  { id: "REQ-011", text: "How do I change the workspace owner? Our previous admin left the company." },
  { id: "REQ-012", text: "Refund request for last month — we were billed for two seats we don't use anymore. Account number 5412-7890-1234-5678." },
  ...
  { id: "REQ-016", text: "We need a custom security review and willing to sign an NDA. Can you connect me with your security team? - Tom Reyes, CISO at Globex." },
